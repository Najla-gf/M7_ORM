from gestionApp.models import Usuario, TipoUsuario, Region, Comuna, TipoInmueble, Inmueble
...
def crear_usuario(nombre, apellido, tipo_usuario_id):
    tipo_usuario = TipoUsuario.objects.get(id=tipo_usuario_id)
    usuario = Usuario(nombre=nombre, apellido=apellido, tipo_usuario=tipo_usuario)
    usuario.save()
    return usuario
