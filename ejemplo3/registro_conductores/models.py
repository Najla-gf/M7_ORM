...
class Conductor(models.Model):
    ...
    def __str__(self) -> str:
        return f"({self.rut} - {self.nombre} {self.apellido} - {self.fecha_nacimiento})"
...
class Direccion(models.Model):
    ...
    conductor = models.OneToOneField("Conductor", null=False, blank=False, on_delete=models.CASCADE) #foreign key
